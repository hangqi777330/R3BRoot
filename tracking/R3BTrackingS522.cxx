...
//cout<<"F2Y"<<tin.f2_y<<endl;
//cout<<"F2Z"<<tin.f2_z<<endl;
//cout<<"F1X"<<tin.f1_x<<endl;
//cout<<"F1Z"<<tin.f1_z<<endl;
//cout<<"F32X"<<tout.f32_x<<endl;
//cout<<"F32Z"<<tout.f32_z<<endl;
//cout<<"F2Y"<<tin_f2_y<<endl;
			...
			//cout<<"P0QQQ---> "<<MDF_PoQ->MDF(mdf_data)<<endl;
